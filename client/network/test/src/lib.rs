...
use substrate_etf_test_runtime_client::AccountKeyring;
pub use substrate_etf_test_runtime_client::{
...
pub type PeersFullClient = Client<
	substrate_etf_test_runtime_client::Backend,
	substrate_etf_test_runtime_client::ExecutorDispatch,
	Block,
	substrate_etf_test_runtime_client::runtime::RuntimeApi,
>;

#[derive(Clone)]
pub struct PeersClient {
	client: Arc<PeersFullClient>,
	backend: Arc<substrate_etf_test_runtime_client::Backend>,
}
...
impl PeersClient {
	...
	pub fn as_backend(&self) -> Arc<substrate_etf_test_runtime_client::Backend> {
		self.backend.clone()
	}
...
pub struct Peer<D, BlockImport> {
	...
	select_chain: Option<LongestChain<substrate_etf_test_runtime_client::Backend, Block>>,
	backend: Option<Arc<substrate_etf_test_runtime_client::Backend>>,
	...
	B: BlockImport<Block, Error = ConsensusError> + Send + Sync,
{
	...
	pub fn select_chain(
		&self,
	) -> Option<LongestChain<substrate_etf_test_runtime_client::Backend, Block>> {
