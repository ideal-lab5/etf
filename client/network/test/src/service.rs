...
struct TestNetworkBuilder {
	...
	client: Option<Arc<substrate_etf_test_runtime_client::TestClient>>,
...
impl TestNetworkBuilder {
	...
	pub fn build(mut self) -> TestNetwork {
		...
		let worker = NetworkWorker::<
			substrate_etf_test_runtime_client::runtime::Block,
			substrate_etf_test_runtime_client::runtime::Hash,
		>::new(config::Params::<substrate_etf_test_runtime_client::runtime::Block> {
