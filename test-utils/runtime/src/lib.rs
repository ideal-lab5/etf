...
use frame_support::{
	...
	parameter_types,
	traits::{ConstU32, ConstU64, ConstBool},
	weights::{
...
pub type AuraId = sp_consensus_etf_aura::sr25519::AuthorityId;
#[cfg(feature = "std")]
pub use extrinsic::{ExtrinsicBuilder, Transfer};

const LOG_TARGET: &str = "substrate-etf-test-runtime";
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	impl_name: create_runtime_str!("etf-test"),
	authoring_version: 1,
	spec_version: 2,
	impl_version: 2,
