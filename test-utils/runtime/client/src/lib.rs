...
pub use substrate_etf_test_runtime as runtime;

pub use self::block_builder_ext::BlockBuilderExt;

use sp_core::storage::ChildInfo;
use substrate_etf_test_runtime::genesismap::GenesisStorageBuilder;
...
impl sc_executor::NativeExecutionDispatch for LocalExecutorDispatch {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		substrate_etf_test_runtime::api::dispatch(method, data)
	}

	fn native_version() -> sc_executor::NativeVersion {
		substrate_etf_test_runtime::native_version()
	}
}

/// Test client database backend.
pub type Backend = substrate_test_client::Backend<substrate_etf_test_runtime::Block>;

/// Test client executor.
pub type ExecutorDispatch = client::LocalCallExecutor<
	substrate_etf_test_runtime::Block,
	Backend,
...
pub type Client<B> = client::Client<
	...
	>,
	substrate_etf_test_runtime::Block,
	substrate_etf_test_runtime::RuntimeApi,
>;
...
pub trait TestClientBuilderExt<B>: Sized {
	...
	fn build_with_longest_chain(
		self,
	) -> (Client<B>, sc_consensus::LongestChain<B, substrate_etf_test_runtime::Block>);
...
impl<B> TestClientBuilderExt<B>
	for TestClientBuilder<
		...
		B,
	> where
	B: sc_client_api::backend::Backend<substrate_etf_test_runtime::Block> + 'static,
{
	fn genesis_init_mut(&mut self) -> &mut GenesisParameters {
