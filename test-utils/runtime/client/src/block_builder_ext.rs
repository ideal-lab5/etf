...
use substrate_etf_test_runtime::*;
...
pub trait BlockBuilderExt {
	...
	fn push_transfer(
		&mut self,
		transfer: substrate_etf_test_runtime::Transfer,
...
impl<'a, A> BlockBuilderExt for sc_block_builder::BlockBuilder<'a, substrate_etf_test_runtime::Block, A>
where
	A: ProvideRuntimeApi<substrate_etf_test_runtime::Block>
		+ sp_api::CallApiAt<substrate_etf_test_runtime::Block>
		+ 'a,
	A::Api: BlockBuilderApi<substrate_etf_test_runtime::Block> + ApiExt<substrate_etf_test_runtime::Block>,
{
	fn push_transfer(
		&mut self,
		transfer: substrate_etf_test_runtime::Transfer,
