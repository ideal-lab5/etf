//! This module contains primitives used by the ETF consensus mechanism.

use crate::{sr25519::AuthorityId, ConsensusLog, MmrRootHash, Vec, AURA_ENGINE_ID};
...
pub struct MmrLeaf<BlockNumber, Hash, LeafData> {
