// // todo:  a custom keystore for managing paillier keypairs
...
// pub(crate) struct ETFKeystore<AuthorityId: AuthorityIdBound>(
// 	Option<KeystorePtr>,
// 	PhantomData<fn() -> AuthorityId>,
// );

// impl<AuthorityId: AuthorityIdBound> ETFKeystore<AuthorityId> {
