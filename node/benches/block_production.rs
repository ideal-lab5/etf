...
// use staging_crate as crate;
use tokio::runtime::Handle;

fn new_node(tokio_handle: Handle) -> crate::service::NewFullBase {
	...
	let spec = Box::new(crate::chain_spec::development_config());
	...
	crate::service::new_full_base(config, None, false, |_, _| ())
