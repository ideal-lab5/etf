...
use node::service::RuntimeExecutor;
...
pub const SPEC_VERSION: u32 = node_template_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = node_template_runtime::VERSION.transaction_version;
