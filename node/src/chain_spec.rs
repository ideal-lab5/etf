...
// // 	// we can add this but we need to modify the sc_cli arg_enums to allow for the bls381 arg
// // 	// for i in 1 2 3 4 ; do for j in session; do subkey inspect --scheme bls381 "$secret"//fir//$j//$i; done; done
...
// // 	let (double_public_bytes, genesis_shares) = etf_genesis::<Tinybls381>(
...
// // 		let t = sp_core::bls::Pair::<Tinybls381>::from(test);
...
use node_template_runtime::{
	...
	crypto::DOLLARS, Block, MaxNominations, SessionKeys, StakerStatus,
};
use pallet_im_online::sr25519::AuthorityId as ImOnlineId;
use sc_chain_spec::ChainSpecExtension;
use sc_service::ChainType;
