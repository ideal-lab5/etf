...
use polkadot_sdk::{
	sc_consensus_grandpa as grandpa,
	*,
};
...
type FullBeefyBlockImport<InnerBlockImport> = beefy::import::BeefyBlockImport<
	...
	FullClient,
	InnerBlockImport,
	// beefy_primitives::bls_crypto::AuthorityId,
>;
...
pub fn new_full_base<N: NetworkBackend<Block, <Block as BlockT>::Hash>>(
	...
	let beefy_gadget = beefy::start_beefy_gadget::<_, _, _, _, _, _, _, _>(beefy_params, transaction_pool.clone());
